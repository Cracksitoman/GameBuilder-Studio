...
export const GamePreviewModal: React.FC<GamePreviewModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black flex items-center justify-center overflow-hidden touch-none select-none">
      <div ref={containerRef} className="relative bg-gray-900 shadow-2xl overflow-hidden" style={{ aspectRatio: `${canvasConfig.width}/${canvasConfig.height}`, width: '100%', height: '100%', maxHeight: '100vh', maxWidth: '100vw', objectFit: 'contain' }}>
